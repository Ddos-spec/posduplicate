...
CREATE TABLE IF NOT EXISTS public.crm_activities (
  id SERIAL PRIMARY KEY,
  tenant_id INTEGER NOT NULL,
  opportunity_id INTEGER NOT NULL REFERENCES public.crm_opportunities(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS public.sales_quotations (
  ...
  notes TEXT,
  opportunity_id INTEGER REFERENCES public.crm_opportunities(id) ON DELETE SET NULL,
  created_by INTEGER,
  created_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
  updated_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
...
CREATE TABLE IF NOT EXISTS public.sales_quotation_items (
  id SERIAL PRIMARY KEY,
  quotation_id INTEGER NOT NULL REFERENCES public.sales_quotations(id) ON DELETE CASCADE,
  item_id INTEGER,
...
CREATE TABLE IF NOT EXISTS public.sales_orders (
  ...
  outlet_id INTEGER,
  customer_id INTEGER,
  quotation_id INTEGER UNIQUE REFERENCES public.sales_quotations(id) ON DELETE SET NULL,
...
CREATE TABLE IF NOT EXISTS public.loyalty_ledger (
  ...
  tenant_id INTEGER NOT NULL,
  customer_id INTEGER NOT NULL,
  wallet_id INTEGER NOT NULL REFERENCES public.loyalty_wallets(id) ON DELETE CASCADE,
