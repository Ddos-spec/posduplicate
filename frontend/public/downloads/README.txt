...
omnipilot-ai-latest.apk

The login page download button uses this path by default:

/downloads/omnipilot-ai-latest.apk

Suggested flow:
1. Build APK from frontend/android
2. Rename the generated file to omnipilot-ai-latest.apk
...
VITE_ANDROID_APP_DOWNLOAD_URL=https://your-domain.com/path/to/omnipilot-ai-latest.apk
