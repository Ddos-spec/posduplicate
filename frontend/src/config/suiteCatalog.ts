...
export const SUITE_APPS: SuiteAppDefinition[] = [
  ...
  { id: 'ecommerce', category: 'websites', name: 'eCommerce', description: 'Online catalog, cart, checkout, customer accounts, delivery, and order lifecycle.', icon: ShoppingBag, bundle: 'commerSocial', status: 'blueprint', path: '/digital', capabilities: ['Catalog', 'Cart', 'Checkout', 'Fulfillment'] },
