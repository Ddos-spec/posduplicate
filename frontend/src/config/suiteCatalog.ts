...
export const SUITE_APPS: SuiteAppDefinition[] = [
  ...
  { id: 'subscriptions', category: 'sales', name: 'Subscriptions', description: 'Recurring plans, renewal lifecycle, recurring billing, and subscription analytics.', icon: Repeat2, bundle: 'accounting', status: 'blueprint', path: '/subscriptions', capabilities: ['Plans', 'Recurring Billing', 'Renewals', 'MRR'] },
