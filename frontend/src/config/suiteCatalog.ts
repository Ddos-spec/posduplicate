...
export const SUITE_APPS: SuiteAppDefinition[] = [
  ...
  // Sales
  { id: 'crm', category: 'sales', name: 'CRM', description: 'Tenant-scoped opportunity pipeline, stage movement, follow-up activities, and customer context.', icon: Target, bundle: 'commerSocial', status: 'live', path: '/revenue', capabilities: ['Opportunities', 'Pipeline Stages', 'Follow-ups', 'Customer Context'] },
  { id: 'sales', category: 'sales', name: 'Sales', description: 'Quotation lifecycle, immutable line snapshots, acceptance, and sales-order conversion.', icon: ShoppingCart, bundle: 'pos', status: 'live', path: '/revenue', capabilities: ['Quotation', 'Line Snapshot', 'Acceptance', 'Sales Order'] },
  ...
  { id: 'subscriptions', category: 'sales', name: 'Subscriptions', description: 'Recurring plans, renewal lifecycle, recurring billing, and subscription analytics.', icon: Repeat2, bundle: 'accounting', status: 'live', path: '/subscriptions', capabilities: ['Plans', 'Recurring Billing', 'Renewals', 'MRR'] },
  { id: 'rental', category: 'sales', name: 'Rental', description: 'Rental products, booking periods, pickup/return, deposit, and availability.', icon: KeyRound, bundle: 'pos', status: 'live', path: '/rental', capabilities: ['Booking', 'Availability', 'Deposit', 'Returns'] },
  ...
  { id: 'ecommerce', category: 'websites', name: 'eCommerce', description: 'Online catalog, cart, checkout, customer accounts, delivery, and order lifecycle.', icon: ShoppingBag, bundle: 'commerSocial', status: 'live', path: '/digital', capabilities: ['Catalog', 'Cart', 'Checkout', 'Fulfillment'] },
  { id: 'elearning', category: 'websites', name: 'eLearning', description: 'Courses, lessons, completion tracking, assessments, and learner portal.', icon: GraduationCap, bundle: 'commerSocial', status: 'live', path: '/learning', capabilities: ['Courses', 'Lessons', 'Quiz', 'Certificates'] },
  { id: 'forum', category: 'websites', name: 'Forum', description: 'Public community Q&A with retry-safe submissions, moderation, and lifecycle controls.', icon: MessagesSquare, bundle: 'commerSocial', status: 'live', path: '/learning', capabilities: ['Q&A', 'Moderation', 'Pinned Topics', 'Retry Safety'] },
  ...
  { id: 'manufacturing', category: 'supply-chain', name: 'Manufacturing', shortName: 'MRP', description: 'BOM-snapshot production orders with material consumption, yield, and output costing.', icon: Factory, bundle: 'inventory', status: 'live', path: '/supply-chain', capabilities: ['BOM Snapshot', 'Production Order', 'Yield', 'Material Cost'] },
  { id: 'purchase', category: 'supply-chain', name: 'Purchase', description: 'Supplier, RFQ, purchase-order lifecycle, and atomic warehouse receiving.', icon: PackageSearch, bundle: 'inventory', status: 'live', path: '/supply-chain', capabilities: ['Suppliers', 'RFQ', 'Purchase Order', 'Receiving'] },
  { id: 'barcode', category: 'supply-chain', name: 'Barcode', description: 'Tenant-scoped barcode aliases and scanner-friendly inventory lookup.', icon: ScanBarcode, bundle: 'inventory', status: 'live', path: '/supply-chain', capabilities: ['Alias Register', 'Scan Lookup', 'Inventory Match', 'Stock Visibility'] },
  { id: 'quality', category: 'supply-chain', name: 'Quality', description: 'Production-output quality queue with pass, fail, waive, and reference traceability.', icon: BadgeCheck, bundle: 'inventory', status: 'live', path: '/supply-chain', capabilities: ['QC Queue', 'Pass / Fail', 'Waive', 'Traceability'] },
  { id: 'maintenance', category: 'supply-chain', name: 'Maintenance', description: 'Equipment register and controlled maintenance-request lifecycle.', icon: Wrench, bundle: 'inventory', status: 'live', path: '/supply-chain', capabilities: ['Equipment', 'Work Request', 'Plan / Start', 'Completion'] },
  ...
  { id: 'marketing-automation', category: 'marketing', name: 'Marketing Automation', description: 'Lifecycle journeys, triggers, conditions, scoring, and automated actions.', icon: Workflow, bundle: 'commerSocial', status: 'partial', path: '/medsos/automations', capabilities: ['Triggers', 'Rules', 'Journeys', 'Actions'] },
  { id: 'events', category: 'marketing', name: 'Events', description: 'Event pages, registrations, tickets, attendees, communication, and reporting.', icon: CalendarDays, bundle: 'commerSocial', status: 'live', path: '/medsos/automations?view=engagement', capabilities: ['Events', 'Registration', 'Ticketing', 'Attendees'] },
  { id: 'surveys', category: 'marketing', name: 'Surveys', description: 'Survey builder, response collection, scoring, segmentation, and analysis.', icon: ClipboardList, bundle: 'commerSocial', status: 'live', path: '/medsos/automations?view=engagement', capabilities: ['Builder', 'Responses', 'Scoring', 'Analytics'] },
  ...
  // Productivity
  { id: 'documents', category: 'productivity', name: 'Documents', description: 'Company files, folders, tags, access, attachment workflow, and record linking.', icon: Files, bundle: 'accounting', status: 'live', path: '/productivity', capabilities: ['Files', 'Folders', 'Tags', 'Record Links'] },
  { id: 'sign', category: 'productivity', name: 'Sign', description: 'Electronic signature requests, templates, recipients, audit trail, and completion.', icon: PenLine, bundle: 'accounting', status: 'live', path: '/productivity', capabilities: ['Templates', 'Recipients', 'Signature', 'Audit'] },
  ...
  { id: 'knowledge', category: 'productivity', name: 'Knowledge', description: 'Internal wiki, SOP, policies, playbooks, linked records, and search.', icon: BookOpen, bundle: 'accounting', status: 'live', path: '/productivity', capabilities: ['Wiki', 'SOP', 'Search', 'Record Links'] },
  ...
  // Platform & governance
  { id: 'studio', category: 'platform', name: 'Studio', description: 'Tenant-scoped custom fields, typed record values, whitelisted workflow rules, and immutable execution receipts.', icon: Sparkles, bundle: 'accounting', status: 'live', path: '/studio', capabilities: ['Custom Fields', 'Typed Values', 'Rule DSL', 'Execution Audit'] },
  ...
  { id: 'customer-database', category: 'commerce', name: 'Customer 360', description: 'Unified customer profile with transaction, receivable, pipeline, and loyalty evidence.', icon: Users, bundle: 'commerSocial', status: 'live', path: '/revenue', capabilities: ['Profiles', 'Transactions', 'Receivables', 'Pipeline'] },
  { id: 'loyalty', category: 'commerce', name: 'Loyalty & Wallet', description: 'Append-only points and monetary-wallet ledger inside Customer 360.', icon: Star, bundle: 'pos', status: 'live', path: '/revenue', capabilities: ['Points Ledger', 'Wallet Ledger', 'Balance', 'Audit History'] },
  ...
  { id: 'anomaly-monitor', category: 'intelligence', name: 'Anomaly Monitor', description: 'Persisted evidence runs for sales signals, scheduled cashflow gaps, margin leakage, stock risk, and demand.', icon: ShieldCheck, bundle: 'accounting', status: 'live', path: '/intelligence', capabilities: ['Sales Signals', 'Cashflow Gap', 'Margin Leakage', 'Stock Risk'] },
  { id: 'ai-copilot', category: 'intelligence', name: 'Evidence Copilot & Actions', description: 'Deterministic source-backed Q&A, demand and replenishment guidance, plus approval-gated RFQ actions.', icon: Sparkles, bundle: 'accounting', status: 'live', path: '/intelligence', capabilities: ['Evidence Q&A', 'Demand Forecast', 'Replenishment', 'Approved Actions'] },
];
