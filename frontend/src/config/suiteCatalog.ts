...
export const SUITE_APPS: SuiteAppDefinition[] = [
  ...
  // Human Resources
  { id: 'employees', category: 'human-resources', name: 'Employees', description: 'Employee master data, organization, documents, status, and employment profile.', icon: Users, bundle: 'accounting', status: 'partial', capabilities: ['Employee Master', 'Organization', 'Documents', 'Employment Data'] },
  { id: 'recruitment', category: 'human-resources', name: 'Recruitment', description: 'Jobs, applicants, recruitment pipeline, interviews, and hiring decisions.', icon: UserRoundSearch, bundle: 'accounting', status: 'blueprint', capabilities: ['Vacancies', 'Applicants', 'Interview', 'Offer'] },
  { id: 'time-off', category: 'human-resources', name: 'Time Off', description: 'Leave types, balances, requests, approvals, calendar, and attendance impact.', icon: CalendarOff, bundle: 'accounting', status: 'blueprint', capabilities: ['Leave Balance', 'Request', 'Approval', 'Calendar'] },
  { id: 'appraisals', category: 'human-resources', name: 'Appraisals', description: 'Performance cycles, goals, reviews, feedback, and development actions.', icon: Star, bundle: 'accounting', status: 'blueprint', capabilities: ['Goals', 'Review Cycle', 'Feedback', 'Development'] },
  ...
  { id: 'attendances', category: 'human-resources', name: 'Attendances', description: 'Clock in/out, attendance logs, lateness, overtime input, and shift records.', icon: Clock3, bundle: 'accounting', status: 'partial', capabilities: ['Clock In/Out', 'Attendance', 'Overtime', 'Shift'] },
  { id: 'payroll', category: 'human-resources', name: 'Payroll', description: 'Payroll periods, salary components, BPJS foundations, PPh 21, and net pay.', icon: Banknote, bundle: 'accounting', status: 'partial', capabilities: ['Payroll Period', 'BPJS', 'PPh 21', 'Net Salary'], localFirst: true },
  ...
  // Services
  { id: 'project', category: 'services', name: 'Project', description: 'Projects, tasks, stages, assignees, milestones, and operational delivery.', icon: FolderKanban, bundle: 'accounting', status: 'blueprint', capabilities: ['Projects', 'Tasks', 'Milestones', 'Workload'] },
  { id: 'timesheets', category: 'services', name: 'Timesheets', description: 'Time logging by user, task, customer, activity, and billable context.', icon: Timer, bundle: 'accounting', status: 'blueprint', capabilities: ['Time Entry', 'Task', 'Customer', 'Billable'] },
  { id: 'planning', category: 'services', name: 'Planning', description: 'Shift planning, assignments, capacity, availability, and scheduling conflicts.', icon: CalendarClock, bundle: 'accounting', status: 'blueprint', capabilities: ['Schedule', 'Capacity', 'Assignment', 'Conflict'] },
  { id: 'field-service', category: 'services', name: 'Field Service', description: 'On-site work orders, technicians, location, parts, photos, and customer sign-off.', icon: MapPin, bundle: 'inventory', status: 'blueprint', capabilities: ['Work Order', 'Technician', 'Parts', 'Sign-off'] },
  { id: 'helpdesk', category: 'services', name: 'Helpdesk', description: 'Tickets, queues, SLA, assignment, customer conversation, and resolution analytics.', icon: LifeBuoy, bundle: 'commerSocial', status: 'partial', path: '/medsos/inbox', capabilities: ['Tickets', 'SLA', 'Routing', 'Resolution'] },
  { id: 'appointments', category: 'services', name: 'Appointments', description: 'Bookable resources, schedule, availability, reminders, and customer booking.', icon: CalendarCheck, bundle: 'commerSocial', status: 'blueprint', capabilities: ['Booking', 'Availability', 'Resource', 'Reminder'] },
