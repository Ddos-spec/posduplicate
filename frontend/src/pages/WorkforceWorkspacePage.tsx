...
import { ArrowLeft, CalendarDays, Clock3, LogIn, LogOut, RefreshCw, Star, UserSearch, Users } from 'lucide-react';
...
type WorkforceTab = 'attendance' | 'leave' | 'recruitment' | 'appraisals';
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100">
      <header className="border-b border-slate-800 bg-slate-950/95 px-4 py-4 md:px-8">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div><p className="text-xs font-bold uppercase tracking-[0.2em] text-cyan-400">P2 Workforce</p><h1 className="text-xl font-black">Workforce Operations</h1><p className="hidden text-xs text-slate-500 md:block">Employees · Attendance · Time Off · Recruitment · Appraisals</p></div>
          </div>
      ...
      <main className="mx-auto max-w-7xl space-y-6 p-4 md:p-8">
        <nav className="grid grid-cols-2 gap-2 rounded-2xl border border-slate-800 bg-slate-900 p-2 md:grid-cols-4" aria-label="Workforce sections">
