...
export default function WaInboxWorkspace({
  ...
  const topStats = useMemo(() => ([
    {
      label: 'Total kontak',
      value: stats?.totalCustomers ?? stats?.totalChats ?? conversations.length,
      helper: 'Semua kontak yang terdaftar',
